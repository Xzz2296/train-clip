...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, first_layer=False, last_layer=False):
        super().__init__()
        ...
        self.num_tokens = 20
        self.prompt_embeddings = nn.Parameter(torch.zeros(self.num_tokens, dim), requires_grad=True)
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.blocks = nn.Sequential(*[
            Block(
                ...
                attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, act_layer=act_layer,first_layer=(i==0),last_layer=(i==depth-1))

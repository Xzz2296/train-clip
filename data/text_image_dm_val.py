...
class TextImageDataModule(LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.dataset2 = TextImageDataset(self.folder2, image_size=self.image_size,resize_ratio=self.resize_ratio,shuffle=self.shuffle,custom_tokenizer=not  self.custom_tokenizer is None)
